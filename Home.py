...
with col1:
    ...
    """, unsafe_allow_html=True)
    if st.button("Launch Scoring Model", key="scoring_button"):
...
with col2:
    ...
    """, unsafe_allow_html=True)
    if st.button("Launch Feasibility Analyzer", key="feasibility_button"):
...
""", unsafe_allow_html=True)
if st.button("Launch Coverage Analyzer", key="coverage_button"):
